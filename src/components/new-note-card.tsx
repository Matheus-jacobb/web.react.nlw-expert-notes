...
export function NewNoteCard({ onNoteCreate }: NewNoteCardProps) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 p-5 gap-3 text-left outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 z-10">
        <span className="text-small font-medium text-slate-">
          Adicionar nota
        </span>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="inset-0 fixed bg-black/60 z-10">
